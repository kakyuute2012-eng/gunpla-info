...
/**
 * バトンストア 商品ページの在庫状況をチェック
 * URL例: https://baton-store.jp/products/XXXXX
 */
export async function checkBatonStock(url: string): Promise<StockCheckResult> {
  try {
    ...
    const priceSelectors = [
      ".product-price", ".price", ".ProductPrice", "[class*='price']",
    ];
