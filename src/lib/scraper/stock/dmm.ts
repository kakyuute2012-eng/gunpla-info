...
/**
 * DMM.com 商品ページの在庫状況をチェック
 */
export async function checkDmmStock(url: string): Promise<StockCheckResult> {
  try {
    ...
    const priceSelectors = [
      ".price", ".productPrice", ".buy__price", "[class*='price']",
    ];
