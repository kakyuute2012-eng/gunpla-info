...
/**
 * タムタムオンラインショップ 商品ページの在庫状況をチェック
 * URL例: https://www.tam-tam.co.jp/shopdetail/XXXXXX/
 */
export async function checkTamtamStock(url: string): Promise<StockCheckResult> {
  try {
    ...
    const priceSelectors = [
      ".item_price", ".price", ".selling_price", "[class*='price']",
    ];
