...
/**
 * ビックカメラ.com 商品ページの在庫状況をチェック
 */
export async function checkBiccameraStock(url: string): Promise<StockCheckResult> {
  try {
    ...
    const priceSelectors = [
      ".bcs_price", ".val", ".productPrice", "[class*='price']",
    ];
